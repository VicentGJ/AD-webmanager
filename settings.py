class Settings:
    ...
    USER_ATTRIBUTES = [["jpegPhoto","Photo"],["cUJAEStudentYear", "Año"], ["cUJAEStudentCourse", "Curso"], ["pager", "Categoría"],["cUJAEDataProvider", "Fuente"], ["cUJAEPersonType", "Tipo"], ["whenCreated", "Fecha de Creación", "time"], ["whenChanged", "Fecha de Modificación", "time"]]
